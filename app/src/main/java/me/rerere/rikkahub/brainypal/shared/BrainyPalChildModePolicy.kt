...
class BrainyPalChildModePolicy private constructor(
    ...
    companion object {
        ...
        val BRAINYPAL_CHILD_ASSISTANT_ID: Uuid = Uuid.parse("4e4ec8a1-5f6b-4c8c-bf45-e0a8ed85d6dc")
        ...
        const val DEVELOPMENT_DEFAULT_BASE_URL = "http://192.168.5.80:8000/rikka/v1"
        ...
        fun brainyPalAssistant(modelId: Uuid): Assistant {
            return Assistant(
                id = BRAINYPAL_CHILD_ASSISTANT_ID,
                chatModelId = modelId,
                name = "BrainyPal",
                systemPrompt = "",
                enableMemory = false,
        ...
        private fun isBrainyPalPracticeUrl(url: String): Boolean {
            ...
            return Regex("""^https?://[^?#]+/child(?:[/?#].*)?$""").matches(url) ||
                Regex("""^https?://[^?#]+/api/v1/child/practice-tasks/[^/?#]+/printable\.pdf(?:[?#].*)?$""")
                    .matches(url)
        }
    }
}
